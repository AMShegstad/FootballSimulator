...
public class PlayerGenerator3D4L {
    ...
    public static List<Player> generateTeamPlayers() {
        ...
        for (Map.Entry<Position, Integer> entry: rosterComposition.entrySet()) {
            ...
            for (int i = 0; i < count; i++) {
                ...
                players.add(generatePlayer(firstName, lastName, hometown, position, usedNumbers)); 
            }
        }
    ...
    private static Player generatePlayer(String firstName, String lastName, String hometown, String college, Position position, Set<Integer> usedNumbers) {
        ...
        int ballCarrierVision, trucking, elusiveness, catchInTraffic, release;
        ...
        switch (position) {
           ...
           // Remove or add parameters below to match the actual Player constructor
           return new Player(firstName, lastName, hometown, college, position, number, height, weight,
